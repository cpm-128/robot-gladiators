// function to set name and not accept a blank
...
var playerInfo = {
    ...
    upgradeAttack: function() {
        if (this.money >= 7) {
            ...
            window.AudioListener("You don't have enough money.");
        } 
    }
};

// function to generate a random whole number 40 - 60
var randomNum = function(min, max) {
    var value = Math.floor(Math.random() * (max - min + 1) + min);
    // return is necessary to return the value to the variable it's stored in
    return value;
};
...
// function to not accept blank or null responses for fight or skip
var fightOrSkip = function() {
    //ask player if they'd like to fight or skip using the fightOrSkip function
    var promptFight = window.prompt("Would you like to FIGHT or SKIP this battle? Enter 'FIGHT' or 'SKIP' to choose.");
        // Conditional recursive function call
        if (!promptFight) {
            window.alert("You must provide a valid response. Please try again.");
            return fightOrSkip();
        }
